...
![Vulkan](images/vulkan2.png) is the cross-platform graphics and compute API created by the Khronos Group. Vulkan was developed in 2016 to solve many problems of the previous APIs, 
