...
The Surface context allows the driver to determine the format, size, quantity, queues, and mode the application can output frames to a given window 
on a given device. The Surface is part of the core WSI extension set because Vulkan is for rendering and not for presenting. If you want to present 
something to the screen, you must enable the necessary extensions. 
